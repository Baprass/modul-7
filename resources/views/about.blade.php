...
<h2>{{$judul4}}</h2><br>
    ...
    <table width="80%" border="0">
      <tr>
        <td class="text-center" rowspan="9" width="40%"><img src="aku.jpg" class="" alt="" width="200ps"></td>
        <td width="40%">Nama : Moch Akbar Bagas Prakasa</td>
      </tr>
      <tr>
        <td>NIM : 210411100034</td>
      </tr>
      <tr>
        <td>Kelas : PAW C</td>
      </tr>
    ...
    <h2>{{$judul5}}</h2><br>
    <div class="">
        <p align="justify">Nama saya Moch Akbar Bagas Prakasa dari Sidoarjo Jawa Timur, Saya merupakan
            anak terakhir dari dua saudara dari Ayah dan Ibu saya, tentunya sebelum saya masuk kedunia pendidikan kuliah
            saya mengenyam dunia pendidikan dimulai dari SD s/d SMK. Saya bersekolah di SD ISLAM ABABIL
            selama 6 tahun, dan dilanjutkan SMP di SMP ULUL ALBAB selama 3 tahun, selanjutnya yaitu SMK
            di SMK ANTARTIKA 2 SIDAORJO selama 3 tahun, setelah itu tentunya waktu dimana kita memikirkan
